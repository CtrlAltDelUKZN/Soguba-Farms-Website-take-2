...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style ="width: 45%; float: left; ">
        ...
        <asp:Button ID="btnAdd" runat="server" BorderStyle="Outset" Text="Insert" />
    ...
    <div style ="width: 9%; float: left; height: 204px;">
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDDLLitterID" DataTextField="LitterID" DataValueField="LitterID">
        </asp:DropDownList>
